...
export default {
  ...
  safelist: [
    ...
    // Explicitly safelist chart colors to be safe
    {
      pattern: /^(fill|text)-(red|orange|yellow|emerald|cyan|violet|fuchsia|lime|amber)-500$/,
    },
  ],
  theme: {
    ...
    extend: {
      colors: {
        // Tremor dark mode tokens (since we are dark mode primarily)
        tremor: {
          brand: {
